...
import navigation from "./pages/layout.js";
...
const app =()=>{
  ...
  new PureCounter();
    ...
    {
     const homePage = document.querySelector(".homeLi").onclick = function(){
    document.querySelector(".main").innerHTML = (home());   
  ...
  new Swiper('.testimonials-slider', {
    ...
    {
     const aboutPage = document.querySelector(".aboutLi").onclick = function(){
    ...
    {
     const galleryPage = document.querySelector(".galleryLi").onclick = function(){
    document.querySelector(".main").innerHTML = (gallery());   
      /**
   * Porfolio isotope and filter
   */
  window.addEventListener('load', () => {
  ...
  new Swiper('.portfolio-details-slider', {
    ...
    {
     const contactPage = document.querySelector(".contactLi").onclick = function(){
